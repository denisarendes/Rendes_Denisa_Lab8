...
using Rendes_Denisa_Lab8.Data;

namespace Rendes_Denisa_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Rendes_Denisa_Lab8Context context, Book book) {
        ...
        public void UpdateBookCategories(Rendes_Denisa_Lab8Context context, string[] selectedCategories, Book bookToUpdate) {
